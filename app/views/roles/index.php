            ...
            <tr>
                ...
                <td>
                    <div class="td-wrapper">
                        <a class="green" href="/roles/edit/<?php echo $role['id']; ?>">Редактировать</a>
                        <a class="red" onclick="return confirm('Вы уверены в этом')" href="/roles/delete/<?php echo $role['id']; ?>">Удалить</a>
                    </div>
                </td>
            </tr>
        <?php endforeach; ?>
