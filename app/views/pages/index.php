            ...
            <tr>
                ...
                <td>
                    <div class="td-wrapper">
                        <a class="green" href="/pages/edit/<?php echo $page['id']; ?>">Редактировать</a>
                        <a class="red" onclick="return confirm('Вы уверены в этом')" href="/pages/delete/<?php echo $page['id']; ?>">Удалить</a>
                    </div>
                </td>
            </tr>
        <?php endforeach; ?>
