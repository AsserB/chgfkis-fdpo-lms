...
<form class="form" method="POST" action="/pages/update/<?php echo $page['id']; ?>">
    ...
    <div class="form-fields">
        ...
        <input type="text" placeholder="Заголовок страницы" id="title" name="title" value="<?php echo $page['title'] ?>" required>

        <label>Адрес страницы</label>
        <input type="text" placeholder="Адрес страницы" id="slug" name="slug" value="<?php echo $page['slug'] ?>" required>
